...
public class GPUImageLookupFilter extends GPUImageFilter {
    ...
    protected void onInitialized(){
    	...
    	runOnDraw(new Runnable(){
    		public void run(){
    			mLookupSourceTexture = OpenGlUtils.loadTextureWithPath(FilterManager.getInstance().getContext(), table);
    		}
    	});
    }
