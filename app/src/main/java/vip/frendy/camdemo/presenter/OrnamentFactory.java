...
import vip.frendy.arcamera.rajawali.CustomMaterialPlugin;
import vip.frendy.arcamera.rajawali.CustomVertexShaderMaterialPlugin;
import vip.frendy.arcamera.util.MaterialFactory;
...
//        modelList.add(crystalBall);
    ...
    private static Ornament getMask(int textureResId, int imgResId, boolean needSkinColor) {
        ...
        model.setRotate(0, 0, 0);
        model.setColor(Ornament.NO_COLOR);
