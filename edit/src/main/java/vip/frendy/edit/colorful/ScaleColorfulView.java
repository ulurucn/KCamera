...
import vip.frendy.edit.mosaic.MosaicPath;
...
public class ScaleColorfulView extends ViewGroup implements ScaleGestureDetector.OnScaleGestureListener {
	...
	private Bitmap bmColorfulLayer;
	...
	private ColorfulUtils.Type mType = ColorfulUtils.Type.COLOR;
	...
	public ScaleColorfulView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		initDrawView();
	}
...
//	}
	...
	private void updatePathMosaic() {
		...
		try {
			...
			bmColorfulLayer = Bitmap.createBitmap(mImageWidth, mImageHeight, Config.ARGB_8888);
			...
			paintEraser.setColor(Color.RED);
			...
			canvas.setBitmap(bmColorfulLayer);
	...
	public Bitmap getMosaicBitmap() {
		...
		canvas.drawBitmap(bmColorfulLayer, 0, 0, null);
		canvas.save();
		return bitmap;
	}
