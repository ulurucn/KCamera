 ...
 * 使用方法:
 * 
 * 1. 创建对象 PhotoFrame  mImageFrame = new PhotoFrame(this,mBitmap);
 * 2. 设置类型 mImageFrame.setFrameType(PhotoFrame.FRAME_SMALL);
 * 3. 初始化相册资源 mImageFrame.setFrameResources()
 * 4. 执行合成 mTmpBmp = mImageFrame.combineFrameRes();
 * 5. 保存
 */
