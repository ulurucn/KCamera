...
public class CanvasView extends FrameLayout {
    ...
    OnCanvasChangeListener onCanvasChangeListener;
    ...
    public void setOnCanvasChangeListener(OnCanvasChangeListener callback) {
        this.onCanvasChangeListener = callback;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (onCanvasChangeListener != null) {
            onCanvasChangeListener.onDraw(canvas);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (onCanvasChangeListener != null) {
            returnValue = onCanvasChangeListener.onTouchEvent(event);
        }
